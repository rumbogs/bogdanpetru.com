    ...
    content: (
      <div>
        ...
        <p>
          ...
          pages and uses plugins (<em>gatsby-config.js</em>, <em>gatsby-node.js</em>). Other than that, you can use
          pretty much all of React&apos;s goodness to basically implement a SPA. All the routing is taken care off by
          Gatsby.
        </p>
        <p>
          ...
          font family you&apos;re currently seeing. One thing Zach mentioned was creating a subset font for loading
          right away with a smaller character base. For that, Michael&apos;s{' '}
          <a href="https://michaeljherold.com/2016/05/04/creating-a-subset-font.html">article</a> was really helpful.
          Just be sure to use <code>pip install --user</code> when installing <code>fonttools</code>.
        </p>
      </div>
    ),
  },
