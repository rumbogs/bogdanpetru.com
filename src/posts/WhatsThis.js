...
const WhatsThis = () => (
  <div>
    ...
    <p>
      The site is built using <a href="https://www.gatsbyjs.org/">Gatsby.js</a> which recently arrived at 1.0 and makes
      it a really nice choice for blogs and small content first websites. It can take a bit of time to get used to the
      architecture, but the documentation has a lot of examples and if something&apos;s missing, you can always check
      the <a href="https://github.com/gatsbyjs/gatsby/tree/master/examples">repository</a> for more information.
    </p>
    <p>
      ...
      <a href="https://gitlab.com/">Gitlab</a>, prerendering to help Google indexing of single page apps and a lot more.
      I use Gitlab for source control instead of Github because it offers support for private repositories for free,
      which might come in handy for my top secret, AI surveillance stuff I usually do.
    </p>
    <p>
    ...
    <p>
      ...
      <a href="https://www.zachleat.com/web/comprehensive-webfonts/">font loading strategy</a> on the Merriweather font
      family you&apos;re currently seeing. One thing Zach mentioned was creating a subset font for loading right away
